...
using SmartSpender.API.Middlewares;
using SmartSpender.DataModel;
using System.Text;
using System.Text.Json;

namespace SmartSpender.API
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddSwaggerGen(options =>
            {
                options.AddSecurityDefinition(name: "Bearer",
                    securityScheme: new OpenApiSecurityScheme
                    {
                        ...
                        "string as following: `Bearer Generated-JWT-Token`",
            ...
            //SQL Server DB
            builder.Services.AddDbContext<SmartSpenderContext>(options =>
            {
